...
CREATE TABLE IF NOT EXISTS CLINICA.DEFINICION(
ID_DEFINICION          INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
NOMBRE      VARCHAR(50),
CLAVE1    	VARCHAR(500),
CLAVE2    	VARCHAR(500),
CLAVE3    	VARCHAR(500),
...
CREATE TABLE IF NOT EXISTS CLINICA.CATALOGO(
...
CREATE TABLE IF NOT EXISTS CLINICA.PROFESIONAL(
...
CREATE TABLE IF NOT EXISTS CLINICA.FICHA(
...
FOREIGN KEY (ID_PROFESIONAL) REFERENCES PACIENTE  (ID_PACIENTE)
);
